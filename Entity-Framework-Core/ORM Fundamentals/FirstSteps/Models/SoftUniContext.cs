...
namespace FirstSteps
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<EmployeesAvgsalary> EmployeesAvgsalaries { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-HHICVBV;Integrated Security=true;Database=SoftUni;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => new { e.FirstName, e.LastName }, "IX_Employees_FirstName_LastName");
            ...
            modelBuilder.Entity<EmployeesAvgsalary>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("EmployeesAVGSalary");
